  ...
  return (
    <main className="container mx-auto max-w-5xl p-6 py-12">
      ...
      >
        ...
        <h1 className="text-4xl font-bold tracking-tight mb-4">Interview Completed</h1>
          ...
          <Card className="border-primary/20 glass-card">
            <CardHeader className="pb-3">
              <CardTitle className="text-xl flex items-center gap-2">
                <Target className="w-5 h-5 text-primary" /> Overall Assessment
              </CardTitle>
            </CardHeader>
            <CardContent>
            ...
            <Card className="h-full border-destructive/20 bg-destructive/5">
              <CardHeader className="pb-3">
                <CardTitle className="text-lg flex items-center gap-2 text-destructive">
                  <Target className="w-5 h-5" /> Areas for Review
                </CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="space-y-3">
          ...
          <Card className="border-amber-500/20 bg-amber-500/5">
            <CardHeader className="pb-3">
              <CardTitle className="text-lg flex items-center gap-2 text-amber-400">
                <Lightbulb className="w-5 h-5" /> Actionable Next Steps
              </CardTitle>
            </CardHeader>
            <CardContent>
              <ul className="space-y-3">
